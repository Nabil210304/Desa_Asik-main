...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-purple-50' }}">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                        <a class="text-blue-500 hover:text-blue-700 mr-2" href="/admin_edit/{{$user->id_user}}">
                            <i class="fas fa-edit"></i>
                        </a>
                        <form action="admin_hapus/{{$user->id_user }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
        ...
        <div class="flex items-center justify-between p-5 bg-white border-t border-gray-200">
            <a href="/tambah_desa" class="bg-purple-600 text-white px-4 py-2 rounded-md text-sm flex items-center hover:bg-purple-700">
