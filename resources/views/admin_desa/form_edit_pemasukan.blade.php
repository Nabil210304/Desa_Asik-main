...
<div class="max-w-7xl mx-auto mb-10 mt-5 bg-white p-8 rounded-lg shadow-lg">
    ...
    @endif
<form action ="/edit_pemasukan/{{$id}}" method="post" enctype="multipart/form-data">
    @csrf
...
<a href="{{ asset('pemasukan/' . $pengeluaran->kuitansi) }}" target="_blank" class="text-blue-500 underline">
    Lihat bukti
</a>
